...
class FireEscapeGUI():
	...
	def create_input_file(self):
        ...
        # program is finished. 
		valid = True
		fhandle = open('tempFire.txt', 'w')										# opens the file for writing
	...
	def display_output(self):
		...
		fhands2 = open('fireout.txt', 'r')										# opens the output file created by the solver
	...
	def solve(self):
		...
		if self.create_input_file():
			system("clingo tempFire.txt fireEscapeASP3.txt | mkatoms > fireout.txt")	# system call using created file and file containging ASP code

		fhands2 = open('fireout.txt', 'r')												# opens the output file to read
